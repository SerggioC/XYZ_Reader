 ...
 */
public class ArticleLoader extends android.support.v4.content.CursorLoader {
    ...
    public static android.support.v4.content.Loader newAllArticlesInstance(Context context) {
        return new ArticleLoader(context, ItemsContract.Items.buildDirUri());
    }

    public static android.support.v4.content.Loader<Cursor> newInstanceForItemId(Context context, long itemId) {
